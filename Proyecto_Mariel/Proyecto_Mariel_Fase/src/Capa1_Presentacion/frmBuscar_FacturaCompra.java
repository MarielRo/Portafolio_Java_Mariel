 ...
 * @author marie
 */
public class frmBuscar_FacturaCompra extends javax.swing.JDialog {

     //Variable global
    DefaultTableModel modelo;
    
    public frmBuscar_FacturaCompra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
         this.setTitle("Buscar factura compra");
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(tblFactura_Compra);
    ...
    private void tblFactura_CompraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblFactura_CompraMouseClicked
        if(evt.getClickCount()==2){
            ...
            txtProveedor.setText(tblFactura_Compra.getValueAt(fila, 1).toString());
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBuscar_FacturaCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmBuscar_FacturaCompra dialog = new frmBuscar_FacturaCompra(new javax.swing.JFrame(), true);
