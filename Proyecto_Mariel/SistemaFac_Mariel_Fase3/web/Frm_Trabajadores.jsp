                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <form action="CrearModificarTrabajador" method="post" id="form_AgregarModificar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="txtCodigo" name="txtCodigo" value="<%=trabajador.getId_trabajador()%>" readonly class="form-control"/><br>
                            <%} else {%>
                        ...
                        <div class="form-group">
                            ...
                            <input type="txt" id="txtApellido" name="txtApellido" value="<%=trabajador.getApellido()%>" class="form-control"/><br>
                        </div>

                        <!-- form-group para los controles de Teléfono -->
                        <div class="form-group">
                            <label for="txtTelefono" class="control-label">Teléfono</label>
                            <input type="txt" id="txtTelefono" name="txtTelefono" value="<%=trabajador.getTelefono()%>" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="txtEmail" name="txtEmail" value="<%=trabajador.getEmail()%>" class="form-control"/><br>
                        </div>
                        
                        <div class="form-group">
                            <label for="txtPuesto" class="control-label">Puesto Trabajo</label>
                            <input type="txt" id="txtPuesto" name="txtPuesto" value="<%=trabajador.getPuesto_trabajo()%>" class="form-control"/><br>
                        </div>
            ...
            $(document).ready(function () {
                $("#form_AgregarModificar").validate({
                    ...
                    rules: {
                        ...
                        txtPuesto : {required: true, maxlength: 35}
                    ...
                    messages: {
                        ...
                        txtPuesto :"El campo Pueto es obligatorio (max 45 caracteres)"
                    },
                    errorElement: 'span'
